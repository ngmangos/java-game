...
public class Portal extends PlaceableEntity {
    ...
    public boolean canTeleportTo(GameMap map, PlaceableEntity entity) {
    ...
    private void doTeleport(GameMap map, PlaceableEntity entity) {
    ...
    public List<Position> getDestPositions(GameMap map, PlaceableEntity entity) {

...
public class BattleStatistics {
    ...
    public void buffAttack(double attackBuff) {
        this.attack += attackBuff;
    }

    public void multBuffHealth(double multHealthBuff) {
        this.health = this.health * multHealthBuff;
    }

    public void buffHealth(double healthBuff) {
